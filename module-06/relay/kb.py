...
def answer(
    ...
    *,
    ...
    Returns an Answer(text, citations, grounded). At Module 5,
    `grounded = bool(citations)` — the citations-present heuristic. Module 9
    recomputes this same field with a real contextual grounding check.
    """
    client = client or _agent_runtime_client()
    kb = resolve_kb_id(kb_id)
    ...
    # treated as grounded. Module 9 swaps this for a real contextual grounding
    # check (a guardrail) that writes this SAME field — name and type unchanged.
