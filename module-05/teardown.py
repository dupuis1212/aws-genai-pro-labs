"""teardown.py — remove Module 5's managed Knowledge Base, keep what M7 needs.

Module 5 of AWS GenAI Pro Mastery. Idempotent and verbose, and TESTED — one tested
teardown per setup (decision B5).

What this DELETES (Module 5's own resources):
...
def assert_clean(delete_vectors_flag: bool, vector_bucket: str,
    ...
    print("\nIdle-billed resources from Module 5: NONE.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Tearing down Module 5 (idempotent).\n")
    ...
    agent, iam, s3v = _agent(), _iam(), _s3vectors()

    try:
        print("Knowledge Base (Bedrock):")
