"""teardown.py — delete IAM roles + guardrail + purge Memory + remove M7's MCP Lambda.

Module 10 of AWS GenAI Pro Mastery. Idempotent and verbose, and TESTED — one tested
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Tearing down Module 10 (idempotent).\n")
