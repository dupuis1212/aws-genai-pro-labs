...
# =============================================================================
# The four Lambda handlers: (logical id, handler dotted path, the HTTP/queue trigger).
# The handler path is `relay.api.<module>.lambda_handler` — the deployed code is the
# unchanged relay/ package (the agent is WRAPPED, never re-implemented).
...
# from 06 §2 — the smoke test diffs this against the frozen contract.
