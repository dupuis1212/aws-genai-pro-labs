"""teardown.py — delete the guardrail + purge AgentCore Memory + remove M7's MCP Lambda.

Module 9 of AWS GenAI Pro Mastery. Idempotent and verbose, and TESTED — one tested
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Tearing down Module 9 (idempotent).\n")
    ...
    try:
        print("Bedrock Guardrail (relay-guardrail — Module 9):")
